...
if(isset($_POST['confirm_payment'])){
    ...
    if($result){
        echo "<script>alert('Succcessfully Completed the payment')</script>";
...
<body class="bg-secondary">
    ...
    <h1 class="text-center text-light">Confirm Payment</h1>
        <form action="" method="post">
            ...
            <div class="form-outline my-4 text-center w-50 m-auto">
                <label for="amount" class="text-light"><strong>Amount</strong></label>
            ...
            <div class="form-outline my-4 text-center w-50 m-auto">
               <input type="submit" value="Confirm" class="bg-dark py-2 px-3 border-0 text-light" name="confirm_payment">
            </div>
        </form>
    </div>
